...
This is the rough first version of our code which was progammed without OOP in mind in order to test various aspects of
the mysql connection with the database and its various perks.
This code does not contain any supplementary code which hasn't been re-organised into the actual different files.
This serves purely as a draft and in order to see code evolution if wanted.
